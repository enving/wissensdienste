---
art: "Formular"
titel: "Muster Sachbericht für Verwendungsnachweis zu Nr. 3.2 BNBest-BMBF 98"
kurzbeschreibung: "Formular im Zuwendungsrecht des Bundes - Altvorhaben, Ressort BMDV"
quelle: https://foerderportal.bund.de/easy/module/profi_formularschrank/download.php?datei1=1024
kategorie: "Altvorhaben"
ministerium: "BMDV"
formular_id: "m_sb_bnbest"
schlagworte: ["altvorhaben", "bmdv", "bund", "foerderrecht"]
stand_bundle: 2026-09-02T10:18:51Z
---

# Muster Sachbericht für Verwendungsnachweis zu Nr. 3.2 BNBest-BMBF 98

# Einordnung

- Dokumentart: **Formular**.
- Antragsart: [Altvorhaben](../../register/nach-kategorie/altvorhaben.md).
- Ressort: [BMDV](../../register/nach-ministerium/bmdv.md).

# Quelle

Original-PDF im Formularschrank des Bundes: <https://foerderportal.bund.de/easy/module/profi_formularschrank/download.php?datei1=1024>
...
- III. Dem Schlussbericht  ist  als  Anlage  ein  kurzgefasster  Erfolgskontrollbericht  beizufügen , der  nicht  veröffentlicht  wird.  Dieser muss darstellen:
1. den Beitrag des Ergebnisses zu den förderpolitischen Zielen, z.B  des Förderprogramms - (ggf. unter Angabe des Schwerpunkts) - soweit dies möglich ist - ,
...
3. die  Fortschreibung  des  Verwertungsplans.  Diese  soll,  soweit  im  Einzelfall  zutreffend,  Angaben  zu  folgenden  Punkten enthalten (Geschäftsgeheimnisse des Zuwendungsempfängers brauchen nicht offenbart zu werden):
...
6. die Einhaltung der Ausgaben- und Zeitplanung.

Im Erfolgskontrollbericht kann auf Abschnitte des Schlussberichts (Nrn. I. und II.) verwiesen werden.

- IV. Mit dem Schlussbericht ist außerdem eine "Kurzfassung" (Berichtsblatt) des wesentlichen fachlichen Inhalts des Schlussberichts nach den dem Zuwendungsbescheid beigefügten "Hinweisen zur Ausfüllung des Berichtsblattes' vorzulegen.
